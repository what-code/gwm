...
public class ImageCodeMakerServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -320486944525582454L;
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getSession(true).setAttribute("randcode", sRand);
		// 将生成的随机数字字符串写入MemCached
		XMemCachedUtil.setCache(id, sRand, 5 * 60);
		// 将生成的sessionId写入Cookie
		CookieUtils.setCooKieValue(Constants.MAKER_CODE_SESSION_ID, id, true, request, response);
